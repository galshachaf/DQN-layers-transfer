...
show_lvls_compare_graph(True,avg_lives_in_lvl5_start_arr,None,'Average lives in when reaching level 5 ','Avg. num. of lives','Evaluation num.',1,4.5,False,True)
show_lvls_compare_graph(True,percent_reached_lvl5_arr,None,'Percent of games reached level 5 ','Percent','Evaluation num.',1,1.5,False,True)
